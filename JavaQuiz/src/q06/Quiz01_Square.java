 ...
 */
public class Quiz01_Square extends Quiz01_GeometricObject implements Quiz01_Colorable {
	private double side;

	public Quiz01_Square() {
		side = 1.0;
	}

	public Quiz01_Square(double side) {
		super("black", false);
		this.side = side;
	}

	public Quiz01_Square(double side, String color, boolean filled) {
		super(color, filled);
		this.side = side;
	}
