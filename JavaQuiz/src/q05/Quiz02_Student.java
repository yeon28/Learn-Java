...
public class Quiz02_Student extends Quiz02_Person {
	...
	public Quiz02_Student() {
		
	}
	
	public Quiz02_Student(String name, String address, String phone, String email, int status) {
