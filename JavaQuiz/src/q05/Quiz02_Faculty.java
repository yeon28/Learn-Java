...
*/
public class Quiz02_Faculty extends Quiz02_Employee {

	private String officeHours;
	private String rank;

	public Quiz02_Faculty() {
	}

	public Quiz02_Faculty(String name, String address, String phone, String email, int office, double salary,
